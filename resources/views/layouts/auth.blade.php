    ...
    <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
        <div class="container">
            <a class="navbar-brand" href="{{ url('/') }}">
                <img src="{{\App\Helpers\AppConfigHelper::GetConfig('LOGO_IMG')}}" style="height:40px;">
            </a>
...
{{--                        @endif--}}
    ...
    <img src="{{\App\Helpers\AppConfigHelper::GetConfig('AUTH_BG_IMG')}}" alt="Image" id="authBackground">
    <main class="py-0">
