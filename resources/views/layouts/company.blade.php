                ...
                <div class="sidebar-content">
                    ...
                    <div class="sidebar-header">
                        ...
                        <div class="user-info">
                            ...
                            <span class="user-role">Bedrijf</span>
                            @endif
                            ...
                            <a class=" p-0 pb-2 dropdown-item custom-link-hover" href="{{ route('logout') }}" onclick="event.preventDefault();
                            ...
                            <div class="input-group">
                                <form action="{{route('search')}}" method="post">@csrf
                                    <div class="input-group-append">
                                        <input style="border-top-right-radius: 0; border-bottom-right-radius: 0;" type="text" class="form-control search-menu" name="query" placeholder="Search...">
                                        <span class="input-group-text" style="border-top-left-radius: 0; border-bottom-left-radius: 0;">
                                            <button style="border:none; background-color:#CECECE; border-radius: 0;" type="submit" class="fa fa-search" aria-hidden="true"></button>
                                        </span>
                                    </div>
                                </form>
                            </div>
                    ...
                    <div class="sidebar-menu">
                        <ul>@if(isset($_SERVER['REQUEST_URI']))
                            ...
                            <li class="sidebar-dropdown">
                                <a href="#"> <i class="fa fa-user"></i>Gebruikers<span class="badge badge-pill badge-warning"></span>
                                </a>
