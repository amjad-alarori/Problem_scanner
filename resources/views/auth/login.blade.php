                    ...
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="form-group row justify-content-center" name="f">
                            ...
                            <div class="col-md-6">
                                ...
                                <input id="email" type="email" class="form-control @error('email') is-invalid @enderror" name="email" placeholder="Emailadres" value="{{ old('email') }}" required autocomplete="email" autofocus>
