...
<body>
<div class="container">
    <img src="{{public_path('img/logos/orange_eyes.jpg')}}">
    <div class="row">
        <div class="col-6"><p style="padding-top:30px;">
                Client:    {{$client}}  <br>
                Afgenomen door: {{$user->name}}
            </p></div>
    </div>
    <div class="row">
        @foreach($questions as $question)
            <div class="col-3" style="width:10%;"> <p style="text-align:center;"><b>{{$question['category']['name']}}</b><br>{{$question['value']}}</p></div>
        @endforeach
    </div>
    <form action="{{route('scan.destroy')}}" method="post">
