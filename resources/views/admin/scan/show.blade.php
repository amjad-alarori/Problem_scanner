        ...
        @else
            <form id="form" action="{{route('results.store')}}" method="post" class="form-group">
                ...
                <label class="scan-label mb-5">
                    ...
                    <span class="row">
                        <span class="col-6">Voer hier de naam of kenmerk of referentie van de cliënt(e) in <input
                                type="text" id="name" name="name" class="form-control" ></span>
                        <span class="col-6"> Of selecteer een van uw bestaande cliënt(e) <select id="selected_user"
                                                                                                 name="selected_user"
                                                                                                 class="form-control">
                        ...
                        <div class="row mb-1">
                            ...
                            @else
                                @foreach($category->questions as $question)
                                    ...
                                    <input type="hidden" value="{{$question->categories_id}}" name="category{{$question->id}}">
