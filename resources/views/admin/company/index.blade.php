                                    ...
                                    <label id="LinkLabel">
                                        <select id="linkSelect" name="link" class="form-control">
                                            ...
                                            @foreach($users as $user)
                                                <option class="LinkOptionGroup{{$user->roles[0]->slug}} LinkOption form-control-item" value="{{$user->id}}">{{$user->name}}</option>
                                            @endforeach
                                        </select>
                                    </label>
                                </td>
                                        ...
                                        <select name="role" class="form-control">
                                            @foreach($roles as $role)
                                                    <option class="form-control-item" value="{{$role->id}}"
                                                            @if($user->roles[0]->name == $role->name) selected @endif>{{$role->name}}</option>
                                            @endforeach
                                        </select>
                                        </td>
                                        <td class="linkedTd" style="display: none">
