    ...
    <div class="container mt-5">
        @if(request()->get('delete'))
            <div class="alert alert-warning">
                You are not allowed to delete a Dutch (nl_NL) component
            </div>
        @endif
        <div class="d-flex justify-content-between">
            <h1>Email component translations</h1>
            <div class="p-2 pr-2">
            ...
            <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog">
                <form action="{{route('emailcomponenttranslation.store')}}" method="post">
                    @csrf
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel">Add component translation</h5>
                            ...
                            <div class="modal-body">
                                <div class="form-group">
                                    ...
                                    <select name="type" class="form-control" required>
                                        @foreach(\App\Helpers\EmailComponentHelper::GetAllPossibleEmailComponentTranslations() as $possibleComponent)
                                            <option value="{{$possibleComponent}}">{{$possibleComponent}}</option>
                                        @endforeach
                                    </select>
                                </div>
...
{{--                                                   class="mr-2"><i class="fa fa-eye"></i></a>--}}
                                                <a href="{{route('emailcomponenttranslation.edit', ['emailcomponenttranslation' => $e->id])}}"><i
